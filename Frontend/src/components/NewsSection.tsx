...
import { BsArrowRight, BsFire, BsStarFill } from "react-icons/bs";
    ...
    <section className="max-w-[1200px] mx-auto py-16 px-4">
      ...
      <div className="flex justify-between items-end mb-8 border-b pb-4 border-gray-200">
        <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Cập nhật công nghệ mới nhất mỗi ngày</p>
        </div>
        ...
        <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="relative w-full h-64 rounded-lg overflow-hidden group cursor-pointer my-[2px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800 flex flex-col items-center justify-center text-center p-4">
                    <span className="text-xs text-indigo-300 border border-indigo-300 px-2 py-0.5 rounded mb-2">Quảng cáo</span>
                    <h5 className="text-white font-bold text-xl mb-1">Mừng Xuân 2026</h5>
                    <p className="text-indigo-200 text-sm mb-3">Giảm giá lên đến 50%</p>
