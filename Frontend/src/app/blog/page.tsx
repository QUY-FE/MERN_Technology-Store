  ...
  return (
    <section className="max-w-[1200px] mx-auto py-8 px-4">
      ...
      <div className="flex justify-between items-center mb-8 pb-4">
        <h2 className="text-2xl text-primary font-bold border-l-4 border-secondary pl-3 uppercase tracking-wide">
          Tin Tức & Đánh Giá
        </h2>
      </div>
              ...
              {sidebarNews.map((item, index) => (
                <li key={index} className="group cursor-pointer">
                  <Link href="#" className="flex gap-2 items-start">
                    ...
                    <span className="text-sm text-gray-600 font-medium group-hover:text-primary transition-colors line-clamp-2">
                      {item}
                    </span>
                  </Link>
                </li>
